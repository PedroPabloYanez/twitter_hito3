class TweetsController < ApplicationController
  ...
  def retweet
    ...
    if retwetted.save
      ...
      redirect_to root_path, notice: 'retweet con éxito.'
    else
  ...
  def create
    ...
    respond_to do |format|
      if @tweet.save
        ...
        format.html { redirect_to root_path, notice: "Failed, without tweet" }
  ...
  private
    ...
    def tweet_params
      params.require(:tweet).permit(:content, :user_id, :image, :photo, :avatar)
    end
end
